...
- **Professor & Employee Management** — Manage university staff records.
- **Course Management** — Add, search (by ID or name), update, delete, and display courses.
- **Department Management** — Organize courses and staff under departments.
...
3. Compile all Java files:
   ```bash
   javac university/models/*.java university/interfaces/*.java university/services/*.java university/exceptions/*.java university/utils/*.java university/Main.java
   ```
...
1. **Add Department** — Create "Computer Science".
2. **Add Professor** — Create "Dr. Ahmed" and assign him to the department.
