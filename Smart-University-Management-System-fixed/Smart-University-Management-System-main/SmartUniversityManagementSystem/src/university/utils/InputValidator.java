...
public class InputValidator {
    ...
    /**
     * Reads an integer that must be between min and max (inclusive).
     */
    ...
    /**
     * Reads a double that must be between min and max (inclusive).
     */
    public double readDoubleInRange(String message, double min, double max) {
        while (true) {
